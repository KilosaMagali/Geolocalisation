...
public class MapDrawerActivityAmi extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        markerPoints.add(amiDestination.getPosition());
        //If no network ->alert
    ...
    private void retrieveAmiPassed() {
       ...
       String categorieLieu="FAILED_TO_PASS_CATEG";
        ...
        LatLng position=new LatLng(latitudeAmi,longitudeAmi);
        amiDestination=new Ami(position,"","");
